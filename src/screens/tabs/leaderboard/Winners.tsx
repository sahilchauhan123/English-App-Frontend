      ...
      <View style={styles.row}>
        ...
        <View style={styles.positionWrapper}>
          <View style={styles.centerItems}>
            ...
            />
            <Text style={styles.winnerName}>Michael</Text>
        ...
        <View style={styles.positionWrapper}>
          <View style={styles.centerItems}>
            ...
            <Image
              style={styles.profilePic}
              source={{ uri: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTht0CJiQlX5WNR5Qe7avmqNMj1kesweoIYY_xY1WTxrJC7S1Y4gv2SRLTh2l6kU8c7ytU&usqp=CAU" }}
            />
            <Text style={styles.winnerName}>Kira</Text>
            <Text style={styles.countryText}>Africa</Text>
          </View>
        ...
        <View style={styles.positionWrapper}>
          <View style={styles.centerItems}>
            ...
            <Image
              style={styles.profilePic}
              source={{ uri: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQumrcwZizGBisyEEmlbllYty5O_LuswiDbj0LnbD8XSJXbALXe0IYV1yDi86ZZYzXYgHA&usqp=CAU" }}
            />
            <Text style={styles.winnerName}>Raman</Text>
            <Text style={styles.countryText}>India</Text>
          </View>
